// Monarch — API Client
// Typed HTTP client for communicating with the Monarch backend
...
export const apiClient = new MonarchApiClient()

/** Create a new client with a custom base URL (for testing) */
export function createApiClient(baseUrl: string): MonarchApiClient {
  return new MonarchApiClient(baseUrl)
}
