...
export const STORAGE_KEYS = {
  SESSIONS: "monarch:sessions",
  ACTIVE_SESSION: "monarch:active-session",
  USER_ID: "monarch:user-id",
  WALLET_ADDRESS: "monarch:wallet-address",
  ANALYTICS_CACHE: "monarch:analytics-cache",
  CERTIFICATES: "monarch:certificates",
  SETTINGS: "monarch:settings",
  OVERLAY_ENABLED: "monarch:overlay-enabled"
} as const
