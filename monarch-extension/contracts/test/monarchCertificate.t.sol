...
/// @title MonarchCertificateTest
/// @notice Comprehensive Foundry test suite for the MonarchCertificate contract.
contract MonarchCertificateTest is Test {
    MonarchCertificate public certificate;
    ...
    function setUp() public {
        certificate = new MonarchCertificate(owner);
    }
    ...
    function test_mint_emitsEvent() public {
        ...
        emit MonarchCertificate.CertificateMinted(1, alice, VIDEO_ID, SCORE, SESSION);
    ...
    function test_mint_revert_duplicateSession() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                MonarchCertificate.SessionAlreadyUsed.selector,
                SESSION
            )
        );
    ...
    function test_mint_revert_invalidScore() public {
        vm.expectRevert(
            abi.encodeWithSelector(
                MonarchCertificate.InvalidCredibilityScore.selector,
                101
            )
        );
    ...
    function test_mint_revert_invalidCompletion() public {
        vm.expectRevert(
            abi.encodeWithSelector(
                MonarchCertificate.InvalidCompletionPercentage.selector,
                101
            )
        );
    ...
    function test_transfer_revert_soulbound() public {
        ...
        vm.prank(alice);
        vm.expectRevert(
            MonarchCertificate.SoulboundTransferNotAllowed.selector
        );
